...
and file transfers, etc.), and tweaks the settings of "tcng":http://tcng.sourceforge.net/
or "tc":http://linux.die.net/man/8/tc to guarantee the service 
levels desired, on the fly.
